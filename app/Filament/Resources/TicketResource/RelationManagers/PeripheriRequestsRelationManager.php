...
class PeripheriRequestsRelationManager extends RelationManager
{
  protected static string $relationship = 'peripheriRequests';
      ...
      ->columns([
        ...
        ->actions([
            Tables\Actions\DeleteAction::make()
                ->action(fn (PeripheriRequest $record) => $record->delete())
  ...
  {
    return $ownerRecord->type === "Peripheri Anfrage";
  }
}
